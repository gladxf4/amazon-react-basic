...
function Cart({ cartItems, onUpdateQuantity, onRemoveItem, onCheckout, onBackToShopping }) {
  ...
  if (checkoutSuccess) {
    return (
      <div className="max-w-[1200px] mx-auto px-4 py-16 flex justify-center items-center">
        <div className="bg-white rounded-lg shadow-xl p-8 md:p-12 max-w-xl w-full border border-gray-100 text-center animate-fade-in">
          ...
          <div className="inline-flex items-center justify-center w-20 h-20 bg-emerald-50 text-emerald-500 rounded-full mb-6 border border-emerald-100 shadow-sm animate-bounce">
  ...
  return (
    <div className="max-w-[1500px] mx-auto p-4 md:py-6 md:px-8">
      {/* Dynamic breadcrumb/header for accessibility */}
          ...
          {cartItems.length === 0 ? (
            <div className="py-12 px-4 flex flex-col items-center justify-center text-center">
              ...
              <button
                ...
                className="bg-gradient-to-b from-[#ffd814] to-[#f7ca00] border border-[#a88734] hover:border-[#846a29] rounded-full py-2.5 px-8 text-sm text-[#111] shadow font-bold transition-all active:scale-[0.98] cursor-pointer"
              >
                Go to Homepage
              </button>
            </div>
              ...
              {cartItems.map((item) => (
                <div key={item.id} className="py-6 flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <div className="flex-grow min-w-0 flex flex-col justify-between">
                    <div>
                      <h3 className="text-base font-semibold text-gray-800 line-clamp-2 hover:text-[#c7511f] cursor-pointer leading-snug">
                        {item.title}
                      </h3>
